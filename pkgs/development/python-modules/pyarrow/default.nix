{ lib, buildPythonPackage, python, isPy3k, fetchurl, arrow-cpp, cmake, cython, futures, hypothesis, numpy, pandas, pytest, pkgconfig, setuptools_scm, six, pytz }:
...
buildPythonPackage rec {
  ...
  checkInputs = [ hypothesis pandas pytest pytz ];
